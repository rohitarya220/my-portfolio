      ...
      <AnimatePresence>
        { isHoverred && (
          <motion.div
           ...
           exit ={{ opacity: 0, x: 25 }}
           className="  absolute bg-white rounded-md px-6 py-2 right-[80px] after:absolute after:-right-1 after:top-3 after:w-3 after:h-3 after:bg-white after:rotate-45"
           style={{ boxShadow: 'inset 0px 0px 10px rgba(0,0,0,0,0.4)'}}
          >
